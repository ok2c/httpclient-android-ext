...
/**
 * Default {@link HttpClientHostnameVerifier} implementation for Android platform.
 * <p>Copied from Apache HttpClient 5.0</p>
 */
@Contract(threading = ThreadingBehavior.IMMUTABLE)
public final class AndroidDefaultHostnameVerifier implements HttpClientHostnameVerifier {
    ...
    public AndroidDefaultHostnameVerifier(final PublicSuffixMatcher publicSuffixMatcher) {
        this.publicSuffixMatcher = publicSuffixMatcher;
    }

    public AndroidDefaultHostnameVerifier() {
        this(null);
    }
